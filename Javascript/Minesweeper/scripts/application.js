function draw_board(x,y){
    ...
    for(var i=0; i<x;i++){
        header.parent().find("#cell").last().append('<td class="cell" id='+i+'><img src="http://www.chezpoor.com/minesweeper/images/blank.gif"</td>');
    }
    ...
    for(var j=0;j<y-1;j++){
        ...
        for(var i=0; i<x;i++){
            header.parent().last().find(".left").last().append('<td class="cell" id='+i+'><img src="http://www.chezpoor.com/minesweeper/images/blank.gif"</td>');
        }
